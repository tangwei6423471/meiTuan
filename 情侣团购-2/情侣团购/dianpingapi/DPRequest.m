...
+ (NSString *)serializeURL:(NSString *)baseURL params:(NSDictionary *)params
{
	...
	NSMutableString *signString = [NSMutableString stringWithString:[[TXWAppDelegate instance] appKey]];
	NSMutableString *paramsString = [NSMutableString stringWithFormat:@"appkey=%@", [[TXWAppDelegate instance] appKey]];
	...
	[signString appendString:[[TXWAppDelegate instance] appSecret]];
